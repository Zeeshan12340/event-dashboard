...
export default function SideBar() {
  ...
  return (
    <div className="flex flex-col m-6 w-18 p-2 bg-white rounded-full">
      {/* menu icon */}
      <button
        type="button"
        aria-label="Toggle expanded events list"
        aria-pressed={page.expandEvents}
        className={
      ...
      <button
        type="button"
        aria-label="Toggle favourite events only"
        aria-pressed={page.likedEvents}
        className={
